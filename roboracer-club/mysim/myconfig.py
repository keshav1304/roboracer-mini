DONKEY_SIM_PATH = "/Users/thoughtworks/Downloads/DonkeySimMac/donkey_sim.app/Contents/MacOS/donkey_sim"
...
SCAN_HEIGHT = 25      # num pixels high to grab from horiz scan
COLOR_THRESHOLD_LOW  = (20, 100, 100) 
COLOR_THRESHOLD_HIGH = (35, 255, 255)

# white line
# COLOR_THRESHOLD_LOW  = (0, 0, 212) 
# COLOR_THRESHOLD_HIGH = (180, 17, 255)

# LineFollower - target (expected) line position and detection thresholds
TARGET_PIXEL = 80   # In not None, then this is the expected horizontal position in pixels of the yellow line.
...
THROTTLE_MAX = 0.35    # maximum throttle value the controller will produce
THROTTLE_MIN = 0.05   # minimum throttle value the controller will produce
...
PID_P = -2.6         # proportional mult for PID path follower
...
# Lane Keeping
# ============================================================================
# To use LaneKeeper instead of LineFollower, change the CV_CONTROLLER settings:
#   CV_CONTROLLER_MODULE = "cv_parts.lane_keeper"
#   CV_CONTROLLER_CLASS  = "LaneKeeper"

# LaneKeeper - lane line color mode
#   "yellow_white"  = yellow line on the left, white line on the right
#   "yellow_yellow" = both lane lines are yellow
LK_LANE_MODE = "yellow_yellow"

# LaneKeeper - scan region (same concept as LineFollower)
LK_SCAN_Y = 60           # num pixels from the top to start horiz scan
LK_SCAN_HEIGHT = 25      # num pixels high to grab from horiz scan

# LaneKeeper - HSV thresholds for the yellow LEFT lane line
LK_YELLOW_LOW  = (20, 100, 100)   # HSV lower bound
LK_YELLOW_HIGH = (40, 255, 255)   # HSV upper bound

# LaneKeeper - HSV thresholds for the white RIGHT lane line
LK_WHITE_LOW  = (0, 0, 200)       # HSV lower bound (low saturation, high value = white)
LK_WHITE_HIGH = (180, 40, 255)    # HSV upper bound

# LaneKeeper - detection thresholds
LK_CONFIDENCE_THRESHOLD = (1 / IMAGE_W) / 3  # min fraction of colored pixels to consider a line detected
LK_TARGET_THRESHOLD = 10  # dead-zone in pixels from lane center before steering changes are made

# LaneKeeper - estimated lane width in pixels
# Used to estimate lane center when only one line is visible.
# Measure this from a screenshot of the simulator at your IMAGE_W resolution.
LK_LANE_WIDTH = 60
