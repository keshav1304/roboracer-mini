...
#
# Camera image preprocessing (rotation / fisheye)
#
# Physical camera mounted upside-down: rotate 180 before CV and web UI.
CAMERA_ROTATE_180 = False

# Fisheye undistortion — disabled until calibrated; set True in myconfig.py.
ENABLE_FISHEYE_UNDISTORT = False
# Placeholder intrinsics (3x3 K matrix). Replace after calibration.
FISHEYE_K = None
# Placeholder distortion coeffs (1x4: k1, k2, k3, k4). Replace after calibration.
FISHEYE_D = None

#
# Computer vision autopilot (path_follow template)
#
USE_CV_AUTOPILOT = False
...
# CV steering PID (separate from path-following PID above)
CV_PID_P = -0.01
CV_PID_I = 0.000
CV_PID_D = -0.0001
CV_PID_P_DELTA = 0.005
CV_PID_D_DELTA = 0.00005
...
# LaneKeeper (switch CV_CONTROLLER_MODULE to cv_parts.lane_keeper to use)
LK_LANE_MODE = "yellow_white"
LK_SCAN_Y = 100
LK_SCAN_HEIGHT = 20
LK_YELLOW_LOW = (20, 100, 100)
LK_YELLOW_HIGH = (40, 255, 255)
LK_WHITE_LOW = (0, 0, 200)
LK_WHITE_HIGH = (180, 40, 255)
LK_CONFIDENCE_THRESHOLD = 0.0015
